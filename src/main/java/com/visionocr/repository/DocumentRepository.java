...
public class DocumentRepository {
    ...
    private static final String UPDATE_JOB = "UPDATE doc_job SET status = ?, doc_type = ?, classifier_label = ?, "
    ...
    private String recordFailure(DocumentRecord d, Stage stage) {
        ...
        jdbc.update("INSERT INTO doc_error (doc_id, stage, attempt_no, error_class, error_message, http_status, retryable) "
                        + "VALUES (?, ?, ?, ?, ?, ?, ?)",
